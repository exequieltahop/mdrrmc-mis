...
@section('auth')
    ...
    <section class="container-fluid p-0 m-0 w-100 overflow-auto">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit-record-modal">Show Modal</button>
    </section>
    
    
    {{-- MODAL EDIT RECORD --}}
    <x-modal id="edit-record-modal" modal-title="Edit Record">
